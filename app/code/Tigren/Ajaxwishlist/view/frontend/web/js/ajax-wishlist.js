    ...
    $.widget('tigren.ajaxWishlist', $.tigren.ajaxSuite, {
        ...
        initEvents: function () {
            ...
            $('body').on('click', self.options.ajaxWishlist.wishlistBtnSelector, function (e) {
                ...
                self.closePopup();
                self.showWishlistPopup(params, e);
            });
        },

        showWishlistPopup: function (params, evnt) {
            var self = this;
            $.ajax({
                ...
                success: function (res) {
                    ...
                    self.addToWishlist($('form.prod_adto_wishlist'));
                    $(evnt.target).removeClass('fa fa-heart-o').addClass('fa fa-heart');
