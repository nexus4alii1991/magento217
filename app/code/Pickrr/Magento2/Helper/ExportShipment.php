...
extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function createShipment($auth_token, $inc_id, $item_name, $from_name, $from_phone_number, $from_pincode, $from_address, $to_name, $to_phone_number, $to_pincode, $to_address, $cod=0.0, $pickup_time = 'NULL', $order_id = 'NULL')
    {
        try{
          ...
          $params = array(
            ...
            $sql = "Insert Into picker_shipping_info (Id, order_id, tracking_id, manifest_link, routing_code, client_order_id) Values ('".$inc_id."','".$order_id."','".$tracking_id."','".$manifest_link."','".$routing_code."','".$client_order_id."')";
            if($connection->query($sql)){
            \Magento\Framework\App\ObjectManager::getInstance()->get('Psr\Log\LoggerInterface')->debug('added');
            }
    ...
    public function createOrderShipment($auth_token, $order, $from_name, $from_phone_number, $from_pincode, $from_address, $cod=0.0, $pickup_time = 'NULL')
    {
        try{
            ...
            $tracking_no = $this->createShipment($auth_token, $inc_id, $item_name, $from_name, $from_phone_number, $from_pincode, $from_address, $to_name, $to_phone_number, $to_pincode, $to_address, $order_id, $pickup_time, $cod);
